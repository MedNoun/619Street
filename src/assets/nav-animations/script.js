jQuery(function () {
    ...
    const gooSlider = function (parent, id) {
        var size = {
            x: $(parent).width(),
            y: $(parent).height()
        };
                ...
                if (waves[i] != undefined) {
                    ...
                    for (var c = 0; c < waves[i].drips.length; c++) {
                        ...
                        waves[i].drips[c] +=
                            ...
                            (noise.simplex2(i * dripsAmount + c, 5) + 1) *
                    ...
                    if (done == true) {
                        ...
                        for (p = 1; p < points.length - 2; p++) {
                            ...
                            context.quadraticCurveTo(
                                ...
                                xc,
                                yc
                            ); // draw the curve to this new point, using the x and y offsets
                        }
